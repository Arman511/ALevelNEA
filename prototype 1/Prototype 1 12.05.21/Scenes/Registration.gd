...
#files in userData saved in format of username,cash,shellMax(20),HPMax(10),hpKitsize(2),ammokitSize(10),normal_sensativity(1),sound(1=true, 0 =false),highscore1,highscore2,highscore3,highscore4,highscore5,type of hud 0 = only text 1 = progress bar, 2 = both\n
...
func addLogin(user, passw):
	...
	var add = content+"\n"+user +",0,20,10,2,10,1,1,0,0,0,0,0,2"
