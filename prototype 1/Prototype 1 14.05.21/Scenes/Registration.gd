...
#,highscore1,highscore2,highscore3,highscore4,highscore5,type of hud 0 = only text 1 = progress bar 2 = both,how to rotate 0 = left and right arrow 1 = a d keys,
# how to fire 0 = f 1 =space 2 = r \n
