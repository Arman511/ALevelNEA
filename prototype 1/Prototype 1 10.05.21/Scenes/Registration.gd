...
#files in userData saved in format of username,normal_sensativity(1),shellMax(20),HPMax(10),hpKitsize(2),ammokitSize(10),highscore1,highscore2,highscore3,highscore4,highscore5\n
